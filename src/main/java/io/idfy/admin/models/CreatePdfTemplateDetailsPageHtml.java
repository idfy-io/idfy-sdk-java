...
/**
 * List of html templates for the details attatchments. If this is set for one or more language, it will override the default template. See our documentation on more info on how to make your own custom template.
 */
@JsonDeserialize(builder = CreatePdfTemplateDetailsPageHtml.Builder.class)
public class CreatePdfTemplateDetailsPageHtml  implements Serializable {
  ...
  private CreatePdfTemplateDetailsPageHtml(Builder builder) {
      en = builder.en;
      no = builder.no;
      sv = builder.sv;
      da = builder.da;
  ...
  public static final class Builder {
    ...
    public Builder(CreatePdfTemplateDetailsPageHtml copy) {
        this.en = copy.getEn();
        this.no = copy.getNo();
        this.sv = copy.getSv();
        this.da = copy.getDa();
    ...
    public CreatePdfTemplateDetailsPageHtml build() { return new CreatePdfTemplateDetailsPageHtml(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    CreatePdfTemplateDetailsPageHtml createPdfTemplateDetailsPageHtml = (CreatePdfTemplateDetailsPageHtml) o;
    return Objects.equals(this.en, createPdfTemplateDetailsPageHtml.en) &&
        Objects.equals(this.no, createPdfTemplateDetailsPageHtml.no) &&
        Objects.equals(this.sv, createPdfTemplateDetailsPageHtml.sv) &&
        Objects.equals(this.da, createPdfTemplateDetailsPageHtml.da) &&
        Objects.equals(this.fi, createPdfTemplateDetailsPageHtml.fi);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePdfTemplateDetailsPageHtml {\n");
