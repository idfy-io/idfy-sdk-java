 ...
 */
@JsonDeserialize(builder = CreatePdfTemplate.Builder.class)
public class CreatePdfTemplate  implements Serializable {
  /**
  ...
  private CreatePdfTemplate(Builder builder) {
      name = builder.name;
  ...
  public static final class Builder {
    ...
    public Builder(CreatePdfTemplate copy) {
    ...
    public CreatePdfTemplate build() { return new CreatePdfTemplate(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, createPdfTemplate.name) &&
        Objects.equals(this.coverPageSetting, createPdfTemplate.coverPageSetting) &&
        Objects.equals(this.addListOfSignaturesOnLastPageOfExistingPDF, createPdfTemplate.addListOfSignaturesOnLastPageOfExistingPDF) &&
        Objects.equals(this.coverPageHtml, createPdfTemplate.coverPageHtml) &&
        Objects.equals(this.detailsPageHtml, createPdfTemplate.detailsPageHtml) &&
        Objects.equals(this.verifiedTemplate, createPdfTemplate.verifiedTemplate) &&
        Objects.equals(this.labels, createPdfTemplate.labels) &&
        Objects.equals(this.includeLogo, createPdfTemplate.includeLogo);
  }
