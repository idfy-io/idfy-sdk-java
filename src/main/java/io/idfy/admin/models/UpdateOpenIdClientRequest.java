 ...
 */
@JsonDeserialize(builder = UpdateOpenIdClientRequest.Builder.class)
public class UpdateOpenIdClientRequest  implements Serializable {
  ...
  private UpdateOpenIdClientRequest(Builder builder) {
  ...
  public static final class Builder {
    ...
    public Builder(UpdateOpenIdClientRequest copy) {
    ...
    public UpdateOpenIdClientRequest build() { return new UpdateOpenIdClientRequest(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    UpdateOpenIdClientRequest updateOpenIdClientRequest = (UpdateOpenIdClientRequest) o;
    return Objects.equals(this.accountId, updateOpenIdClientRequest.accountId) &&
        Objects.equals(this.clientId, updateOpenIdClientRequest.clientId) &&
        Objects.equals(this.clientName, updateOpenIdClientRequest.clientName) &&
        Objects.equals(this.enabled, updateOpenIdClientRequest.enabled) &&
        Objects.equals(this.clientUri, updateOpenIdClientRequest.clientUri) &&
        Objects.equals(this.requireConsent, updateOpenIdClientRequest.requireConsent) &&
        Objects.equals(this.allowRememberConsent, updateOpenIdClientRequest.allowRememberConsent) &&
        Objects.equals(this.flow, updateOpenIdClientRequest.flow) &&
        Objects.equals(this.allowClientCredentialsOnly, updateOpenIdClientRequest.allowClientCredentialsOnly) &&
        Objects.equals(this.redirectUris, updateOpenIdClientRequest.redirectUris) &&
        Objects.equals(this.postLogoutRedirectUris, updateOpenIdClientRequest.postLogoutRedirectUris) &&
        Objects.equals(this.logoutUri, updateOpenIdClientRequest.logoutUri) &&
        Objects.equals(this.requireSignOutPrompt, updateOpenIdClientRequest.requireSignOutPrompt) &&
        Objects.equals(this.allowedScopes, updateOpenIdClientRequest.allowedScopes) &&
        Objects.equals(this.identityProviderRestrictions, updateOpenIdClientRequest.identityProviderRestrictions) &&
        Objects.equals(this.identityTokenLifetime, updateOpenIdClientRequest.identityTokenLifetime) &&
        Objects.equals(this.accessTokenLifetime, updateOpenIdClientRequest.accessTokenLifetime) &&
        Objects.equals(this.absoluteRefreshTokenLifetime, updateOpenIdClientRequest.absoluteRefreshTokenLifetime) &&
        Objects.equals(this.slidingRefreshTokenLifetime, updateOpenIdClientRequest.slidingRefreshTokenLifetime) &&
        Objects.equals(this.refreshTokenUsage, updateOpenIdClientRequest.refreshTokenUsage) &&
        Objects.equals(this.updateAccessTokenClaimsOnRefresh, updateOpenIdClientRequest.updateAccessTokenClaimsOnRefresh) &&
        Objects.equals(this.refreshTokenExpiration, updateOpenIdClientRequest.refreshTokenExpiration) &&
        Objects.equals(this.accessTokenType, updateOpenIdClientRequest.accessTokenType) &&
        Objects.equals(this.includeJwtId, updateOpenIdClientRequest.includeJwtId) &&
        Objects.equals(this.alwaysSendClientClaims, updateOpenIdClientRequest.alwaysSendClientClaims) &&
        Objects.equals(this.allowedCorsOrigins, updateOpenIdClientRequest.allowedCorsOrigins) &&
        Objects.equals(this.allowAccessTokensViaBrowser, updateOpenIdClientRequest.allowAccessTokensViaBrowser);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, clientId, clientName, enabled, clientUri, requireConsent, allowRememberConsent, flow, allowClientCredentialsOnly, redirectUris, postLogoutRedirectUris, logoutUri, requireSignOutPrompt, allowedScopes, identityProviderRestrictions, identityTokenLifetime, accessTokenLifetime, absoluteRefreshTokenLifetime, slidingRefreshTokenLifetime, refreshTokenUsage, updateAccessTokenClaimsOnRefresh, refreshTokenExpiration, accessTokenType, includeJwtId, alwaysSendClientClaims, allowedCorsOrigins, allowAccessTokensViaBrowser);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateOpenIdClientRequest {\n");
