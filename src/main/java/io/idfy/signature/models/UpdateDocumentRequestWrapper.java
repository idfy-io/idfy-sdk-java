 ...
 */
@JsonDeserialize(builder = UpdateDocumentRequestWrapper.Builder.class)
public class UpdateDocumentRequestWrapper  implements Serializable {
  ...
  private UpdateDocumentRequestWrapper(Builder builder) {
      title = builder.title;
  ...
  public static final class Builder {
    ...
    public Builder(UpdateDocumentRequestWrapper copy) {
    ...
    public UpdateDocumentRequestWrapper build() { return new UpdateDocumentRequestWrapper(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    UpdateDocumentRequestWrapper updateDocumentRequestWrapper = (UpdateDocumentRequestWrapper) o;
    return Objects.equals(this.title, updateDocumentRequestWrapper.title) &&
        Objects.equals(this.description, updateDocumentRequestWrapper.description) &&
        Objects.equals(this.notification, updateDocumentRequestWrapper.notification) &&
        Objects.equals(this.contactDetails, updateDocumentRequestWrapper.contactDetails) &&
        Objects.equals(this.advanced, updateDocumentRequestWrapper.advanced);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDocumentRequestWrapper {\n");
