 ...
 */
@JsonDeserialize(builder = ExpiredReceipt.Builder.class)
public class ExpiredReceipt  implements Serializable {
  /**
  ...
  private ExpiredReceipt(Builder builder) {
      email = builder.email;
      sms = builder.sms;
  }
  ...
  public static final class Builder {
    ...
    public Builder(ExpiredReceipt copy) {
    ...
    public ExpiredReceipt build() { return new ExpiredReceipt(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    ExpiredReceipt expiredReceipt = (ExpiredReceipt) o;
    return Objects.equals(this.email, expiredReceipt.email) &&
        Objects.equals(this.sms, expiredReceipt.sms);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpiredReceipt {\n");
