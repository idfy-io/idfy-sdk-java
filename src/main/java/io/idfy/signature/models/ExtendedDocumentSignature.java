 ...
 */
@JsonDeserialize(builder = ExtendedDocumentSignature.Builder.class)
public class ExtendedDocumentSignature  implements Serializable {
  /**
  ...
  private ExtendedDocumentSignature(Builder builder) {
  ...
  public static final class Builder {
    ...
    public Builder(ExtendedDocumentSignature copy) {
    ...
    public ExtendedDocumentSignature build() { return new ExtendedDocumentSignature(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    ExtendedDocumentSignature extendedDocumentSignature = (ExtendedDocumentSignature) o;
    return Objects.equals(this.signerId, extendedDocumentSignature.signerId) &&
        Objects.equals(this.externalSignerId, extendedDocumentSignature.externalSignerId) &&
        Objects.equals(this.signatureMethod, extendedDocumentSignature.signatureMethod) &&
        Objects.equals(this.fullName, extendedDocumentSignature.fullName) &&
        Objects.equals(this.firstName, extendedDocumentSignature.firstName) &&
        Objects.equals(this.lastName, extendedDocumentSignature.lastName) &&
        Objects.equals(this.middleName, extendedDocumentSignature.middleName) &&
        Objects.equals(this.signedTime, extendedDocumentSignature.signedTime) &&
        Objects.equals(this.dateOfBirth, extendedDocumentSignature.dateOfBirth) &&
        Objects.equals(this.signatureMethodUniqueId, extendedDocumentSignature.signatureMethodUniqueId) &&
        Objects.equals(this.socialSecurityNumber, extendedDocumentSignature.socialSecurityNumber) &&
        Objects.equals(this.clientIp, extendedDocumentSignature.clientIp) &&
        Objects.equals(this.mechanism, extendedDocumentSignature.mechanism) &&
        Objects.equals(this.personalInfoOrigin, extendedDocumentSignature.personalInfoOrigin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signerId, externalSignerId, signatureMethod, fullName, firstName, lastName, middleName, signedTime, dateOfBirth, signatureMethodUniqueId, socialSecurityNumber, clientIp, mechanism, personalInfoOrigin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExtendedDocumentSignature {\n");
