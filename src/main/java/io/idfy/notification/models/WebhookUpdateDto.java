 ...
 * WebhookUpdateDto
 */
@JsonDeserialize(builder = WebhookUpdateDto.Builder.class)
public class WebhookUpdateDto  implements Serializable {
  ...
  private WebhookUpdateDto(Builder builder) {
      name = builder.name;
  ...
  public static final class Builder {
    ...
    public Builder(WebhookUpdateDto copy) {
    ...
    public WebhookUpdateDto build() { return new WebhookUpdateDto(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    WebhookUpdateDto webhookUpdateDto = (WebhookUpdateDto) o;
    return Objects.equals(this.name, webhookUpdateDto.name) &&
        Objects.equals(this.active, webhookUpdateDto.active) &&
        Objects.equals(this.events, webhookUpdateDto.events) &&
        Objects.equals(this.config, webhookUpdateDto.config) &&
        Objects.equals(this.tags, webhookUpdateDto.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookUpdateDto {\n");
