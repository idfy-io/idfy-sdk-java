 ...
 * WebhookCreateConfig
 */
@JsonDeserialize(builder = WebhookCreateConfig.Builder.class)
public class WebhookCreateConfig  implements Serializable {
  /**
  ...
  private WebhookCreateConfig(Builder builder) {
      url = builder.url;
  ...
  public static final class Builder {
    ...
    public Builder(WebhookCreateConfig copy) {
    ...
    public WebhookCreateConfig build() { return new WebhookCreateConfig(this); }
  }
  @Override
  public boolean equals(java.lang.Object o) {
    ...
    WebhookCreateConfig webhookCreateConfig = (WebhookCreateConfig) o;
    return Objects.equals(this.url, webhookCreateConfig.url) &&
        Objects.equals(this.secret, webhookCreateConfig.secret) &&
        Objects.equals(this.deliveryLogging, webhookCreateConfig.deliveryLogging);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookCreateConfig {\n");
