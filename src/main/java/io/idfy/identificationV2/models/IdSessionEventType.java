...
import java.io.Serializable;
 ...
 /**
   * Gets or Sets IdSessionEventType
   */
  public enum IdSessionEventType {
   ...
   INFORMATION("information");
    ...
    IdSessionEventType(String value) {
      this.value = value;
    }
    ...
    public static IdSessionEventType fromValue(String text) {
      for (IdSessionEventType b : IdSessionEventType.values()) {
